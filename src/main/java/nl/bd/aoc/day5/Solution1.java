...
public class Solution1 {
    ...
    {
        int maxSize = 10;
        List<String> input = FileUtils.readFromFile("day5/input_test.txt");
        ...
        for (String line : input) {
            ...
            if (inputLine.direction().equals(Direction.HORIZONTAL) ||
                inputLine.direction().equals(Direction.VERTICAL) ) {

                List<Point> points = inputLine.getPointsInLine();
